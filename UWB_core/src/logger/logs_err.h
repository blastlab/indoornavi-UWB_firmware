...
ADD_ITEM_M(1102, ERR_BAD_OPCODE_LEN, "%s bad len %d!=%d")
ADD_ITEM_M(1103, ERR_BAD_OPCODE, "unknown opcode %Xh")
ADD_ITEM_M(1104, ERR_BAD_COMMAND, "Bad command")
...
ADD_ITEM_M(1107, ERR_BASE64_TOO_LONG_INPUT, "TXT_Bin too long base64 message")
ADD_ITEM_M(1107, ERR_BASE64_TOO_LONG_OUTPUT, "LOG_Bin too long base64 message, FC:%xh")
...
ADD_ITEM_M(1212, ERR_BLE_INACTIVE, "BLE is disabled")
...
ADD_ITEM_M(1303, ERR_SETTAGS_NEED_SETANCHORS, "settags need setanchors")
ADD_ITEM_M(1303, ERR_SETTAGS_FAILED, "settags failed after %X")
