...
// ranging TDOA
ADD_ITEM_M(1350, INF_TDOA_BEACON_FROM_TAG, "tdoa_tag did:%X seq:%d anchor:%X mV:%d serial:%X%08X tsrg:%X%08X tsrl:%X%08X")
ARG("did", "tag short identification number")
ARG("seq", "measurement sequence number")
...
ADD_ITEM_M(1351, INF_TDOA_BEACON_FROM_ANCHOR, "tdoa_anchor at:%X seq:%d ar:%X tstg:%X%08X tstl:%X%08X tsrg:%X%08X tsrl:%X%08X tof:%d")
