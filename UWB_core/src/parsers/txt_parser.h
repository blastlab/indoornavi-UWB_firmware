 ...
 * 
 * Each message should be transformated from text to correct struct and function code.
 * Struct with function code should be transformed to binary message and parsed by binary parser.
 * Such mechanism helps to keep code consistent and help to avoid code doubling in text and binary parser.
 * 
 * @file txt_parser.h
