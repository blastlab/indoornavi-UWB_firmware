...
void FC_RFSET_SET_cb(const void* data, const prot_packet_info_t* info) {
  ...
  if (packet.plen == DWT_PLEN_64 || packet.plen == DWT_PLEN_128 ||
      packet.plen == DWT_PLEN_256 || packet.plen == DWT_PLEN_512 ||
      packet.plen == DWT_PLEN_1024 || packet.plen == DWT_PLEN_1536 ||
