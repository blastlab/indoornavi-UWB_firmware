...
#define MAC_SETTINGS_DEF                                                       \
  {                                                                            \
    .addr = ADDR_BROADCAST, .pan = 0xDECA, .slot_time = 123,                   \
    .slot_guard_time = 10, .slot_number = 15, .slots_sum_time = 12345,         \
    .max_frame_fail_cnt = 3, .raport_anchor_anchor_distance = true,            \
  }
